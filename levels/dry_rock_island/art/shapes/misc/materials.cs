singleton Material(terrain_grass2)
{
   ...
   diffuseMap[0] = "levels/dry_rock_island/art/terrains/Grass-02-D.dds";
   normalMap[0] = "levels/dry_rock_island/art/terrains/Grass-02-N.dds";
   doubleSided = "1";
...
singleton Material(AsphaltRoad_laned_mesh)
{
   ...
   diffuseMap[0] = "levels/dry_rock_island/art/road/AsphaltRoad_laned_d.dds";
   normalMap[0] = "levels/dry_rock_island/art/road/AsphaltRoad_laned_n.dds";
   specular[0] = "0.996078 0.996078 0.996078 1";
   specularPower[0] = "1";
   pixelSpecular[0] = "0";
   specularMap[0] = "levels/dry_rock_island/art/road/AsphaltRoad_laned_s.dds";
   useAnisotropic[0] = "1";
...
singleton Material(parkinglot_01_a_terrain_rockydirt)
{
   ...
   doubleSided = "1";
   translucentBlendOp = "None";
   diffuseMap[0] = "levels/dry_rock_island/art/terrains/RockyDirt-01-D.dds";
   normalMap[0] = "levels/dry_rock_island/art/terrains/RockyDirt-01-N.dds";
   specularMap[0] = "levels/dry_rock_island/art/terrains/RockyDirt-01-S.dds";
};
