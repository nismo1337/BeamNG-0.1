...
{      
   ...
   flareTexture = "levels/dry_rock_island/art/lights/lensFlareSheet0";  
...
datablock LightFlareData(SunFlareExample3)
{
   ...
   flareEnabled = true;
   renderReflectPass = false;
   flareTexture = "levels/dry_rock_island/art/lights/lensflareSheet3.png";  
...
datablock LightFlareData( LightFlareExample0 )
{
   ...
   flareTexture = "levels/dry_rock_island/art/lights/lensFlareSheet1";
